...
__all__ = [
    'SpeechRunState', 'tagSTATSTG', 'IStream',
    'SWPUnknownWordUnpronounceable', 'DISPID_SOTsCount',
    'DISPID_SpeechLexicon', 'DISPID_SVSVisemeId',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPDKL_CurrentConfig', 'SASRun',
    'DISPID_SLPSymbolic', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SLGetPronunciations',
    'SVEEndInputStream', 'SPSInterjection', 'DISPID_SGRSTRule',
    'SPFILEMODE', 'SPEI_RESERVED5', '_ISpeechRecoContextEvents',
    'DISPID_SRDisplayUI', 'SPWF_INPUT', 'SpMMAudioIn', 'SASPause',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechVoiceSpeakFlags',
    'DISPID_SOTCDefault', 'SVEPhoneme', 'SRSActiveAlways',
    'ISpLexicon', 'DISPID_SVVolume', 'IEnumSpObjectTokens', 'SPRULE',
    'SRAORetainAudio', 'SPLO_DYNAMIC', 'SECFIgnoreWidth',
    'ISpProperties', 'SSTTWildcard', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechMMSysAudio', 'DISPID_SCSBaseStream',
    'DISPID_SPCIdToPhone', 'SVSFIsXML', 'DISPID_SPIGetText',
    'SpeechGrammarState', 'ISequentialStream', 'SpMMAudioOut',
    'SDA_No_Trailing_Space', 'DISPID_SRCESoundEnd',
    'SpeechFormatType', 'ISpeechPhraseProperty', 'DISPID_SLPLangId',
    'ISpeechGrammarRule', 'ISpRecoGrammar2', 'SVEAllEvents',
    'SLODynamic', 'SPFM_CREATE_ALWAYS', 'SAFT12kHz8BitMono',
    'DISPID_SABIBufferSize', 'DISPID_SPEEngineConfidence',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechObjectToken',
    'DISPID_SPRuleChildren', 'ISpeechRecoResult2',
    'DISPID_SVEAudioLevel', 'DISPID_SRCVoice', 'DISPID_SPIRule',
    'DISPID_SPIEnginePrivateData', 'SPRS_ACTIVE', 'SpStream',
    'SPVPRI_OVER', 'SpSharedRecoContext', 'SpeechTokenValueCLSID',
    'eLEXTYPE_RESERVED6', 'DISPID_SVSPhonemeId', 'DISPID_SVPause',
    'SBOPause', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SGRAttributes', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRGCmdLoadFromResource',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRInitialState',
    'DISPID_SPACommit', 'Speech_StreamPos_Asap',
    'Speech_Default_Weight', 'STCInprocHandler', 'DISPID_SGRId',
    'SAFTCCITT_uLaw_11kHzMono', 'SECHighConfidence',
    'SPEI_END_INPUT_STREAM', 'SpeechRecoEvents',
    'DISPID_SVSInputSentencePosition', 'SPEI_MIN_SR',
    'DISPID_SGRSAddSpecialTransition', 'SpeechPartOfSpeech',
    'DISPID_SRGDictationLoad', 'DISPID_SAStatus',
    'SRADefaultToActive', 'eLEXTYPE_RESERVED7', 'SITooLoud',
    'DISPID_SVEStreamEnd', 'SPXRO_Alternates_SML',
    'SpeechWordPronounceable', 'SFTInput', 'DISPID_SRRAudioFormat',
    'DISPID_SpeechGrammarRule', 'SPDATAKEYLOCATION',
    'SPBO_TIME_UNITS', 'ISpObjectToken', 'SITooSlow',
    'ISpGrammarBuilder', 'SGSEnabled', 'SREBookmark',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SOTsItem',
    'SDKLCurrentConfig', 'DISPID_SOTSetId', 'DISPID_SOTCSetId',
    'ISpStreamFormat', 'DISPID_SASetState', 'SAFTADPCM_22kHzMono',
    'DISPID_SPRsItem', 'DISPID_SOTCGetDataKey', 'SPSHT_EMAIL',
    'SP_VISEME_13', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SOTGetAttribute', 'ISpeechLexiconWords',
    'DISPID_SpeechLexiconWord', 'eLEXTYPE_PRIVATE13',
    'SPEI_START_INPUT_STREAM', 'SPEI_PHONEME', 'SINone',
    'SAFT11kHz16BitMono', 'SpeechDisplayAttributes',
    'SREPropertyNumChange', 'SVEPrivate', 'DISPID_SOTCreateInstance',
    'eLEXTYPE_USER', 'SPBO_AHEAD', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPEActualConfidence', 'eLEXTYPE_PRIVATE19',
    'SAFTGSM610_11kHzMono', 'DISPID_SVGetAudioOutputs',
    'DISPID_SDKEnumValues', 'SECFNoSpecialChars',
    'SAFTExtendedAudioFormat', 'DISPID_SPPValue',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPPFirstElement',
    'DISPID_SPIProperties', 'SPEVENT', 'SPVOICESTATUS',
    'SpeechCategoryRecoProfiles', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechRecoResult', 'DISPID_SGRs_NewEnum',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_4',
    'SPADAPTATIONRELEVANCE', 'SpSharedRecognizer',
    'SPCT_SUB_DICTATION', 'SRTReSent', 'SPCT_DICTATION',
    'DISPID_SPRuleFirstElement', 'STCRemoteServer', 'SRCS_Enabled',
    'SPEI_SENTENCE_BOUNDARY', 'SP_VISEME_14', 'SWTAdded',
    ...
    'DISPID_SRCEventInterests', 'DISPID_SRCERequestUI', 'SGDisplay',
    'DISPID_SVESentenceBoundary', 'DISPID_SGRClear', 'DISPID_SOTId',
    'SVP_17', 'DISPID_SDKOpenKey', 'SP_VISEME_10', 'SP_VISEME_0',
    'STCLocalServer', 'SRCS_Disabled',
    'DISPID_SPRuleNumberOfElements', 'SP_VISEME_15', 'SpCustomStream',
    'ISpeechAudioFormat', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_PRIVATE4', 'STSF_FlagCreate', 'SPEI_MAX_TTS',
    'DISPID_SDKDeleteKey', 'SPPHRASEPROPERTY',
    'SpeechEmulationCompareFlags', 'SRADynamic', 'SPPS_LMA', 'SVP_13',
    'SpeechStreamFileMode', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SVP_4', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SPIEngineId',
    'DISPID_SMSADeviceId', 'DISPID_SPRuleConfidence',
    'SpeechRegistryUserRoot', 'DISPID_SAFGuid',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVEVoiceChange', 'DISPID_SRGSetTextSelection',
    'DISPID_SpeechPhraseReplacement', 'SVP_16', 'DISPID_SDKEnumKeys',
    'SECNormalConfidence', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SREInterference', 'SVP_9', 'SAFTADPCM_8kHzMono', 'UINT_PTR',
    'DISPID_SRCEAudioLevel', 'SAFT16kHz8BitMono',
    'SpeechInterference', 'ISpPhrase', 'SAFT44kHz8BitMono',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPEs_NewEnum',
    'DISPID_SDKGetBinaryValue', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPAsItem',
    'SpeechGrammarTagWildcard', 'DISPID_SGRSTPropertyId',
    'ISpDataKey', 'SREStateChange', 'STCAll', 'SpeechAudioProperties',
    'ISpRecoContext', 'DISPID_SpeechPhraseAlternate',
    'SPSEMANTICERRORINFO', 'DISPID_SLWsCount',
    'DISPID_SVSyncronousSpeakTimeout', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPVPRIORITY', 'SPDKL_LocalMachine', 'IInternetSecurityMgrSite',
    'SVP_15', 'DISPID_SMSALineId', 'DISPID_SGRSTransitions', 'SVP_14',
    'tagSPPROPERTYINFO', 'SPBINARYGRAMMAR', 'SP_VISEME_12',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SPRulesItem',
    'SAFTADPCM_11kHzStereo', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SWFEBitsPerSample', 'SVP_18', 'DISPID_SGRSTPropertyName',
    'DISPID_SAVolume', 'SAFT48kHz16BitMono', 'SREPhraseStart',
    'STSF_AppData', 'SDKLCurrentUser', 'DISPID_SpeechPhraseElements',
    'SpeechRecoContextState', 'SpeechLoadOption',
    'DISPID_SVSInputSentenceLength', 'SPRST_INACTIVE', 'SPSNoun',
    'DISPID_SPPsItem', 'SWTDeleted', 'DISPID_SOTDisplayUI',
    'SPEI_PHRASE_START', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVStatus', 'SAFTDefault', 'DISPID_SRCState', 'SGDSActive',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPPConfidence',
    'SAFTNonStandardFormat', 'ISpeechVoice',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPAPhraseInfo', 'SASClosed',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVAudioOutput',
    'DISPID_SPIReplacements', 'SP_VISEME_1', 'DISPID_SRGRules',
    'ISpeechPhraseRules', 'SAFTText', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechRecognitionType', 'SRESoundEnd', 'SAFT24kHz8BitStereo',
    'DISPID_SPEDisplayAttributes', 'SVP_12', 'SREStreamStart',
    'eLEXTYPE_PRIVATE17', 'DISPID_SAFType', '_ISpeechVoiceEvents',
    'SSSPTRelativeToEnd', 'SRAImport', 'SAFT44kHz16BitStereo',
    'ISpeechObjectTokenCategory', 'SRATopLevel',
    'DISPID_SRCEStartStream', 'DISPID_SLWs_NewEnum',
    'DISPID_SRCRequestedUIType', 'SpeechAddRemoveWord',
    'SPAUDIOBUFFERINFO', 'SGSDisabled', 'DISPID_SRRSpeakAudio',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRCEHypothesis', 'ISpPhoneticAlphabetSelection',
    'SPSModifier', 'SDTRule', 'eLEXTYPE_PRIVATE3', 'ISpRecoGrammar',
    'ISpRecoContext2', 'SAFT32kHz16BitStereo', 'DISPID_SGRsFindRule',
    'DISPID_SRCCreateResultFromMemory', 'SpResourceManager',
    'SAFTGSM610_8kHzMono', 'Speech_Max_Pron_Length',
    'DISPID_SPIGrammarId', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRAudioInput', 'ISpPhraseAlt', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCreateRecoContext', 'DISPID_SRCBookmark',
    'SAFTADPCM_8kHzStereo', 'DISPID_SLPPhoneIds',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SRAONone',
    'DISPID_SpeechRecoResult2', 'SPFM_OPEN_READONLY',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPEVENTENUM',
    'ISpeechAudio', 'DISPID_SRCERecognition', 'DISPID_SGRAddState',
    'DISPID_SRCEBookmark', 'DISPID_SPPEngineConfidence',
    'ISpeechAudioStatus', 'SAFTADPCM_44kHzStereo', 'DISPID_SRGState',
    'DISPID_SpeechFileStream', 'DISPID_SVAlertBoundary',
    'SPEI_SR_AUDIO_LEVEL', 'SPAS_RUN',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPEI_TTS_PRIVATE',
    'SPPS_Noncontent', 'ISpeechGrammarRuleStateTransition',
    'SPPS_RESERVED1', 'SPAS_CLOSED', 'SPEI_RECOGNITION',
    'SPPHRASEREPLACEMENT', 'SPEI_PROPERTY_NUM_CHANGE',
    'eLEXTYPE_MORPHOLOGY', 'SPWORDPRONUNCIATION',
    'DISPID_SRGDictationUnload', 'ISpeechMMSysAudio', 'SPAUDIOSTATE',
    'SpeechAudioFormatGUIDWave', 'SAFT16kHz8BitStereo',
    'SVEWordBoundary', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_USER_SHORTCUT',
    'ISpeechResourceLoader', 'SASStop', 'SpInProcRecoContext',
    'SVEStartInputStream', 'DISPID_SADefaultFormat',
    'DISPID_SpeechPhraseRules', 'SPSNotOverriden',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRIsUISupported', 'SPCT_SUB_COMMAND', 'DISPID_SPRuleId',
    'SINoise', 'SpeechUserTraining', 'SPSUnknown', 'DISPID_SPCLangId',
    'SPINTERFERENCE_NOISE', 'ISpeechRecoResultDispatch',
    'DISPID_SFSOpen', 'SPPS_Noun', 'DISPID_SRGCmdLoadFromFile',
    'eWORDTYPE_ADDED', 'DISPID_SRRTimes', 'SAFT11kHz16BitStereo',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRGCmdLoadFromMemory',
    'SRSEIsSpeaking', 'DISPID_SVRate', 'SPRST_NUM_STATES',
    'eLEXTYPE_PRIVATE20', 'SRAInterpreter', 'SVEViseme',
    'SREAdaptation', 'DISPID_SpeechBaseStream', 'SPINTERFERENCE',
    'DISPID_SRCERecognizerStateChange', 'SAFT32kHz16BitMono',
    'DISPID_SABIEventBias', 'SpeechRecognizerState',
    'DISPID_SpeechPhraseRule', 'SPEI_UNDEFINED',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SpeechPhraseProperty', 'SpeechTokenShellFolder',
    'DISPID_SRGetRecognizers', 'SPRECOGNIZERSTATUS',
    'SGPronounciation', 'SPEI_RESERVED6',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SABIMinNotification',
    'SPFM_OPEN_READWRITE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SGRSRule',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechPhraseReplacements',
    'SPRECOSTATE', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPRuleParent', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SLWLangId',
    'DISPID_SVGetProfiles', 'ISpeechPhraseAlternate',
    'DISPID_SpeechAudio', 'DISPID_SVEViseme', 'ISpRecoResult',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SWFEFormatTag',
    'SAFTADPCM_44kHzMono', 'SRESoundStart', 'SLTUser',
    'SRSInactiveWithPurge', 'SPSSuppressWord', 'DISPID_SPAsCount',
    ...
    'SAFT32kHz8BitStereo', 'DISPID_SRRGetXMLErrorInfo', 'SPLO_STATIC',
    'DISPID_SRRSaveToMemory', 'ISpEventSource', 'SP_VISEME_6',
    'DISPID_SpeechLexiconPronunciation', 'SPRS_INACTIVE',
    'DISPID_SRCResume', 'DISPID_SRGetPropertyNumber', 'SpObjectToken',
    'SPPS_Function', 'SpeechTokenContext', 'SVSFIsNotXML',
    'DISPID_SGRsAdd', 'SAFT48kHz16BitStereo',
    'DISPID_SRSNumberOfActiveRules', 'SpeechAudioFormatType',
    'SpeechStreamSeekPositionType', 'SPEI_END_SR_STREAM',
    'SPFM_NUM_MODES', 'SPEI_INTERFERENCE', 'SPEI_MAX_SR',
    'DISPID_SGRSTsCount', 'DISPID_SGRsCommit', 'DISPID_SRStatus',
    'SpPhraseInfoBuilder', 'SpeechRetainedAudioOptions',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPWT_PRONUNCIATION',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'WAVEFORMATEX',
    'DISPID_SLWType', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPEPronunciation', 'SREPrivate', 'SPWAVEFORMATTYPE',
    'ISpeechRecoGrammar', 'SPCT_COMMAND', 'SpCompressedLexicon',
    'ISpSerializeState', 'DISPID_SPPId', 'eLEXTYPE_PRIVATE14',
    'SAFT8kHz16BitStereo', 'ISpeechRecoResult',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRAudioInputStream',
    'SPPARTOFSPEECH', 'SPWORDPRONUNCIATIONLIST', 'STCInprocServer',
    'SAFTGSM610_44kHzMono', 'SpeechWordType',
    'DISPID_SpeechPhraseInfo', 'SRTStandard',
    'DISPID_SRCRetainedAudio', 'SREFalseRecognition', 'SPWT_DISPLAY',
    'DISPID_SpeechPhraseElement', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SBSWrite', 'SP_VISEME_20', 'SVSFNLPMask',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPPChildren',
    'ISpeechPhraseReplacement', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SMSGetData', 'DISPID_SLAddPronunciation', 'DISPIDSPTSI',
    'SSFMCreateForWrite', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SpeechGrammarRuleStateTransition', 'SGRSTTDictation',
    'DISPID_SPEsCount', 'SPBO_NONE', 'SSFMOpenReadWrite',
    'SAFT44kHz8BitStereo', 'DISPID_SLGetGenerationChange',
    'DISPID_SBSSeek', 'DISPID_SRRPhraseInfo', 'DISPID_SRRTLength',
    'SDKLDefaultLocation', 'SPPROPERTYINFO', 'SPPS_RESERVED3',
    'DISPID_SpeechVoiceEvent', 'SGRSTTWildcard', 'DISPID_SRGId',
    'DISPID_SPPsCount', 'SPCONTEXTSTATE', 'SVSFlagsAsync',
    'DISPID_SPRNumberOfElements', 'SPPHRASERULE',
    'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRCEPropertyNumberChange', 'SAFT12kHz8BitStereo',
    'ISpObjectWithToken', 'SpMMAudioEnum',
    'DISPID_SRCERecognitionForOtherContext', 'SAFTADPCM_11kHzMono',
    'SPAR_High', 'SAFT22kHz8BitStereo',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SASState', 'SPAO_NONE',
    'SVP_1', 'ISpeechPhraseRule', 'DISPID_SLWPronunciations',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRCSetAdaptationData', 'SVEBookmark',
    'DISPID_SpeechGrammarRules', 'SAFTCCITT_ALaw_8kHzMono',
    'SPBOOKMARKOPTIONS', 'DISPID_SDKGetStringValue', 'SVF_None',
    'ISpObjectTokenCategory', 'DISPIDSPRG', 'SpeechCategoryVoices',
    'DISPID_SRGetFormat', 'SPWORDTYPE', 'SpeechPropertyResponseSpeed',
    'DISPID_SPILanguageId', 'SVP_8', 'SVEVoiceChange',
    'DISPID_SPERetainedStreamOffset', 'SpMemoryStream',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPERetainedSizeBytes',
    'SAFT8kHz8BitMono', 'SRTEmulated', 'SP_VISEME_19',
    'DISPID_SPIStartTime', 'DISPID_SRCPause', 'SRSInactive',
    ...
    'ISpeechMemoryStream', 'DISPID_SRRGetXMLResult', 'SPGRAMMARSTATE',
    'DISPID_SPPParent', 'SAFTCCITT_uLaw_8kHzStereo', 'SpLexicon',
    '__MIDL_IWinTypes_0009', 'SRERequestUI', 'SPCS_ENABLED',
    'DISPID_SOTGetStorageFileName', 'SGRSTTTextBuffer',
    'SPEI_HYPOTHESIS', 'ISpPhoneticAlphabetConverter', 'SGRSTTRule',
    'ISpMMSysAudio', 'DISPID_SASNonBlockingIO', 'DISPID_SFSClose',
    'SPPS_Modifier', 'SRSActive', 'DISPID_SVIsUISupported',
    ...
    '_RemotableHandle', 'SpeechSpecialTransitionType',
    'SSTTTextBuffer', 'DISPID_SpeechPhraseProperties',
    'SAFT12kHz16BitStereo', 'DISPID_SVEWord', 'ISpeechGrammarRules',
    'DISPID_SpeechRecoContextEvents', 'ISpEventSink',
    'DISPID_SPRules_NewEnum', 'DISPID_SWFESamplesPerSec',
    'SPEI_SR_RETAINEDAUDIO', 'SVSFNLPSpeakPunc', 'SPPS_Verb',
    'DISPID_SRCEAdaptation', 'SPGRAMMARWORDTYPE',
    'DISPID_SPAs_NewEnum', 'SpeechEngineConfidence',
    'DISPID_SDKSetStringValue', 'ISpeechLexiconPronunciation',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVSInputWordPosition',
    'ISpeechObjectTokens', 'SPDKL_DefaultLocation', 'SBONone',
    'SVSFParseAutodetect', 'SPINTERFERENCE_TOOQUIET', 'SPBO_PAUSE',
    'SVP_6', 'SDTAlternates', 'DISPID_SpeechRecoResultTimes',
    'SREStreamEnd', 'ISpeechRecoContext', 'DISPID_SPELexicalForm',
    'SpVoice', 'DISPID_SpeechMemoryStream', 'SDTReplacement',
    'SpInprocRecognizer', 'SDA_Two_Trailing_Spaces', 'SPAUDIOSTATUS',
    'SVP_19', 'SpeechTokenIdUserLexicon', 'SPSMF_UPS', 'SP_VISEME_9',
    'SRERecognition', 'ISpeechLexiconWord', 'SPGS_ENABLED',
    'SP_VISEME_5', 'SPSLMA', 'SpeechAudioVolume',
    'tagSPTEXTSELECTIONINFO', 'SpShortcut',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SVSLastBookmarkId',
    'DISPID_SOTs_NewEnum', 'SVP_10', 'STSF_LocalAppData',
    'SWPKnownWordPronounceable', 'SpeechPropertyResourceUsage',
    'SVF_Stressed', 'ISpShortcut', 'eLEXTYPE_VENDORLEXICON',
    'SPWORDLIST', 'SFTSREngine', 'DISPID_SPRs_NewEnum',
    'ISpeechTextSelectionInformation', 'DISPID_SPRsCount',
    'ISpRecognizer3', 'eLEXTYPE_APP', 'DISPID_SMSAMMHandle',
    'DISPID_SPRFirstElement', 'DISPID_SpeechAudioFormat',
    'ISpeechXMLRecoResult', 'DISPID_SVEPhoneme', 'IEnumString',
    ...
    'ISpeechPhraseElement', 'SSFMOpenForRead', 'SINoSignal',
    'SpeechRuleAttributes', 'SVP_5', 'SAFT48kHz8BitMono',
    'ISpResourceManager', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRRTTickCount', 'SPEI_MIN_TTS', 'SPEI_RESERVED2',
    'ISpeechObjectToken', 'ISpeechWaveFormatEx',
    'SAFTADPCM_22kHzStereo', 'SVPOver', 'SpeechTokenKeyUI',
    'ISpeechLexicon', 'SRTAutopause', 'ISpeechPhraseElements',
    'DISPID_SpeechAudioStatus', 'DISPID_SVEStreamStart',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPIAudioSizeBytes',
    'SPTEXTSELECTIONINFO', 'SpeechGrammarRuleStateTransitionType',
    ...
    'DISPID_SDKCreateKey', 'SAFT8kHz16BitMono',
    'SpeechGrammarTagDictation', 'SVP_21',
    'DISPID_SRRSetTextFeedback', 'DISPID_SVSkip',
    'SGDSActiveUserDelimited', 'SREPropertyStringChange',
    'ISpStreamFormatConverter', 'SPFM_CREATE', 'SpeechAudioState',
    'SGRSTTWord', 'SPDKL_CurrentUser', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVSLastBookmark', 'SPEI_RESERVED3', 'SVSFParseSsml',
    'ISpAudio', 'ISpVoice', 'SpeechDictationTopicSpelling',
    'SPINTERFERENCE_NONE', 'DISPID_SPPs_NewEnum', 'SVP_11',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechLexiconWords',
    'DISPID_SABufferNotifySize', 'SpeechDataKeyLocation',
    'DISPID_SVAudioOutputStream', 'DISPID_SpeechPhraseBuilder',
    'SpFileStream', 'DISPID_SOTCId', 'Speech_Max_Word_Length',
    'SpUnCompressedLexicon', 'SVPAlert', 'SECFDefault',
    'SpeechVoicePriority', 'DISPID_SPEsItem', 'ISpeechBaseStream',
    'SGSExclusive', 'SpObjectTokenCategory', 'DISPID_SRCEEndStream',
    'ISpeechVoiceStatus', 'DISPID_SOTIsUISupported',
    'DISPID_SPERequiredConfidence', 'DISPID_SLRemovePronunciation',
    'ISpPhoneConverter', 'SAFT24kHz16BitStereo',
    'DISPID_SpeechRecognizer', 'DISPID_SOTCategory',
    'SAFT24kHz16BitMono', 'DISPID_SWFEBlockAlign', 'SPSEMANTICFORMAT',
    'DISPID_SVEventInterests', 'SPPS_NotOverriden',
    'DISPID_SABufferInfo', 'DISPID_SPPNumberOfElements',
    'DISPID_SVPriority', 'DISPID_SVSInputWordLength',
    'SPAUDIOOPTIONS', 'ISpRecognizer', 'SpWaveFormatEx',
    'ISpRecoCategory', 'SPSHT_Unknown', 'DISPID_SRSClsidEngine',
    'SSSPTRelativeToStart', 'SP_VISEME_21', 'DISPID_SRGRecoContext',
    'SLOStatic', 'SRSEDone', 'SVSFIsFilename',
    'DISPID_SRRTStreamTime', 'SDTProperty', 'SDTPronunciation',
    'DISPID_SGRsItem', 'SPSHORTCUTPAIR', 'SPAO_RETAIN_AUDIO',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPLOADOPTIONS',
    'DISPID_SRGCmdSetRuleIdState', 'SPAR_Low',
    'SAFTTrueSpeech_8kHz1BitMono', 'SGDSActiveWithAutoPause',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_RESERVED8',
    'SpeechBookmarkOptions', 'SpeechMicTraining',
    'SpeechPropertyAdaptationOn', 'eLEXTYPE_PRIVATE2',
    'SAFT16kHz16BitMono', 'SPSTREAMFORMATTYPE', 'SPSHT_NotOverriden',
    'SPWF_SRENGINE', 'DISPID_SpeechWaveFormatEx', 'SP_VISEME_8',
    'DISPID_SOTGetDescription', 'DISPID_SRCCreateGrammar',
    'DISPID_SWFEChannels', 'SAFT8kHz8BitStereo', 'SVP_20',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPAStartElementInResult',
    'SAFTNoAssignedFormat', 'SAFT32kHz8BitMono', 'SGDSInactive',
    'SVPNormal', 'SpeechGrammarTagUnlimitedDictation',
    'eLEXTYPE_RESERVED9', 'SP_VISEME_11', 'SVSFPersistXML',
    'SSFMCreate', 'eLEXTYPE_PRIVATE12', 'SAFT44kHz16BitMono',
    'SPSFunction', 'Speech_StreamPos_RealTime', 'DISPID_SLPsItem',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRRAudio',
    'DISPID_SGRSTType', 'DISPID_SOTCEnumerateTokens',
    'SAFT22kHz8BitMono', 'SECLowConfidence', 'ISpNotifyTranslator',
    'ISpXMLRecoResult', 'SSSPTRelativeToCurrentPosition',
    'SpeechRegistryLocalMachineRoot', 'SP_VISEME_3',
    'SpNullPhoneConverter', 'SRERecoOtherContext',
    'DISPID_SVGetVoices', 'SP_VISEME_16', 'DISPID_SPRuleName',
    'SITooQuiet', 'DISPID_SPIElements', 'DISPID_SRSAudioStatus',
    'DISPID_SVSpeak', 'SpeechRuleState', 'SLTApp', 'SPSHORTCUTTYPE',
    'DISPID_SRState', 'SREAllEvents', 'DISPID_SpeechObjectTokens',
    'DISPID_SVSLastResult', 'SPEI_SOUND_START',
    'ISpeechPhraseAlternates', 'DISPID_SLWWord', 'SVP_7',
    'SSTTDictation', 'SPWT_LEXICAL', 'DISPID_SLPs_NewEnum',
    'SVESentenceBoundary', 'SAFT24kHz8BitMono', 'SPEI_VOICE_CHANGE',
    'SPSERIALIZEDPHRASE', 'SDTAudio', 'SPPHRASE',
    'SAFT22kHz16BitMono', 'DISPID_SVSRunningState', 'SPPS_Unknown',
    'DISPID_SGRSTText', 'SpeechTokenKeyFiles', 'DISPID_SPCPhoneToId',
    'DISPID_SVSCurrentStreamNumber', 'eLEXTYPE_PRIVATE18',
    'DISPID_SLPPartOfSpeech', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SBSRead', 'DISPID_SDKSetLongValue', 'SPAS_PAUSE',
    'ISpNotifySource', 'SPRULESTATE', 'DISPID_SRProfile',
    'DISPID_SRRRecoContext', 'eLEXTYPE_PRIVATE8',
    'SAFTGSM610_22kHzMono', 'SPCT_SLEEP', 'SPPS_RESERVED2',
    'DISPID_SpeechCustomStream', 'DISPID_SRRecognizer',
    'SPSMF_SAPI_PROPERTIES', 'SVEAudioLevel', 'SVSFUnusedFlags',
    'SPVPRI_ALERT', '_SPAUDIOSTATE', 'ISpeechLexiconPronunciations',
    'DISPID_SRSetPropertyString', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRCCmdMaxAlternates', 'SDKLLocalMachine',
    'SpeechGrammarWordType', 'SRTSMLTimeout', 'SPVPRI_NORMAL',
    'SPEI_VISEME', 'SVSFDefault', 'SDTDisplayText',
    'DISPID_SBSFormat', 'SP_VISEME_2', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechPhraseReplacements',
    'SpPhoneConverter', 'SP_VISEME_7', 'DISPID_SRGDictationSetState',
    'SGLexical', 'SPXRO_SML', 'SPPS_SuppressWord', 'SVP_2',
    'SpTextSelectionInformation', 'SWPUnknownWordPronounceable',
    'LONG_PTR', 'ISpeechFileStream', 'DISPID_SpeechDataKey',
    'SPRECORESULTTIMES', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPXMLRESULTOPTIONS', 'SAFTCCITT_uLaw_44kHzMono',
    'eLEXTYPE_RESERVED10', 'SAFT12kHz16BitMono', 'SPEVENTSOURCEINFO',
    'SPWORD', 'ISpeechGrammarRuleState', 'DISPID_SRCEPhraseStart',
    'DISPID_SLWsItem', 'SPPHRASEELEMENT', 'STSF_CommonAppData',
    'SPCS_DISABLED', 'DISPID_SVDisplayUI', 'SPCATEGORYTYPE',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SGRsCount', 'DISPID_SPPName', 'DISPID_SPRulesCount',
    'ISpStream', 'SPEI_SR_BOOKMARK', 'SpeechVoiceEvents', 'SRAExport',
    'DISPID_SPISaveToMemory', 'DISPID_SRCVoicePurgeEvent',
    'SECFIgnoreKanaType', 'ISpeechRecognizerStatus', 'SGRSTTEpsilon',
    'SPEI_TTS_BOOKMARK', 'SpeechLexiconType', 'SPEI_SOUND_END',
    'SREHypothesis', 'SAFT16kHz16BitStereo', 'SPPS_RESERVED4',
    'SRTExtendableParse', 'SDTLexicalForm', 'SPSERIALIZEDRESULT',
    'DISPID_SGRsDynamic', 'SpPhoneticAlphabetConverter',
    'DISPID_SPRText', 'DISPID_SpeechVoice',
    'DISPID_SGRsCommitAndSave', 'SITooFast', 'SAFT11kHz8BitStereo',
    'ISpNotifySink', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRGReset', 'SPAS_STOP', 'SPEI_REQUEST_UI',
    'SPEI_ADAPTATION', 'ISpeechDataKey', 'SPAR_Unknown',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SVEEnginePrivate',
    'SP_VISEME_17', 'SpeechCategoryAudioOut', 'SPLEXICONTYPE',
    'SP_VISEME_18', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SDKDeleteValue', 'DISPID_SpeechRecoContext',
    'eLEXTYPE_PRIVATE11', 'ISpeechPhraseInfo',
    'DISPID_SRCESoundStart', 'SVSFParseMask', 'SVSFVoiceMask',
    'SPEI_RESERVED1', 'SREAudioLevel',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SVEBookmark',
    'SPVISEMES', 'DISPID_SMSSetData', 'DISPID_SVWaitUntilDone',
    'SpeechCategoryAudioIn', 'SpAudioFormat', 'SPGS_DISABLED',
    'SVP_3', 'SpeechEngineProperties', 'DISPID_SGRSTNextState',
    'DISPID_SAFSetWaveFormatEx', 'SECFIgnoreCase',
    'SAFT11kHz8BitMono', 'ISpeechRecognizer',
    'DISPID_SAFGetWaveFormatEx', 'SRARoot', 'DISPID_SPEDisplayText',
    'DISPID_SOTDataKey', 'DISPID_SRIsShared', 'SPSHORTCUTPAIRLIST',
    'SPSVerb', 'eLEXTYPE_PRIVATE10', 'ISpeechRecoResultTimes',
    'DISPID_SLGenerationId', 'DISPID_SGRSTWeight', 'SVF_Emphasis',
    'SVSFParseSapi', 'SDTAll', 'SpeechAudioFormatGUIDText',
    'SAFT48kHz8BitStereo', 'ISpeechPhoneConverter',
    'DISPID_SLPsCount', 'SPEI_START_SR_STREAM',
    'DISPID_SDKGetlongValue', 'DISPID_SpeechAudioBufferInfo',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRGetPropertyString',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRCRecognizer',
    'ISpeechCustomStream', 'DISPID_SLGetWords',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpStreamFormatConverter', 'eWORDTYPE_DELETED',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRGCommit', 'SPAR_Medium',
    'DISPID_SWFEExtraData', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRRAlternates', 'SpeechPropertyLowConfidenceThreshold',
    'SpeechAllElements', 'DISPID_SVResume', 'SPRST_ACTIVE',
    'SPGS_EXCLUSIVE', 'SpeechCategoryAppLexicons',
    'DISPID_SREmulateRecognition', 'SVP_0',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRSCurrentStreamNumber',
    'ISpRecognizer2', 'ISpeechPhraseProperties',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SAEventHandle',
    'SPSHT_OTHER', 'SpeechDiscardType', 'eLEXTYPE_LETTERTOSOUND',
